...
SEED =  19963
# load data
perg = ['N Palavras corpo','N Palavras Titulo','N frases corpo','flesch','Media Caracteres Frase','Tamanho Codigo','Interogacao','Inicia com WH','Subjetividade','Polaridade','N de tags','N perguntas Feitas','N respostas Feitas','hora','Rotulo']

print('Começou...')
Perguntas=pd.read_csv('C:\\Users\\joaor\\Desktop\\HORA.csv',sep='\t',usecols=perg)
print('Acabou...')
...
binss = [1,2,3,5]
x1 = Perguntas.loc[Perguntas.Rotulo==0.0, Feature]
x2 = Perguntas.loc[Perguntas.Rotulo==1.0, Feature]
...
#=================//=========================================================//===================================================//=================================
g = sns.kdeplot(Perguntas[Feature][(Perguntas['Rotulo'] == 0) & (Perguntas[Feature])], color="Red", shade = False)
g = sns.kdeplot(Perguntas[Feature][(Perguntas['Rotulo'] == 1) & (Perguntas[Feature])], ax =g, color="Blue", shade= False)
