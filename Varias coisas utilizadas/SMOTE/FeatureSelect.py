...
# load data
filename = 'C:\\Users\\joaor\\Desktop\\SMOTE_TREINO.csv'
...
pg= ['N Palavras corpo','N Palavras Titulo','N frases corpo','flesch','Media Caracteres Frase','Tamanho Codigo','Interogacao','Inicia com WH','Subjetividade','Polaridade','N de tags','N perguntas Feitas','N respostas Feitas','Rotulo']

perg3 = ['N Palavras corpo','N Palavras Titulo','N frases corpo','flesch','Media Caracteres Frase','Tamanho Codigo','Interogacao','Inicia com WH','Subjetividade','Polaridade','N de tags','N perguntas Feitas','N respostas Feitas','hora','Feriado/FimSem','Rotulo']

print('Começou...')
dataframe=pd.read_csv(filename,sep='\t',usecols=perg3, encoding='utf-8')
...
sampledata = {'genre': ['N Palavras corpo','N Palavras Titulo','N frases corpo','flesch','Media Caracteres Frase','Tamanho Codigo','Interogacao','Inicia com WH','Subjetividade','Polaridade','N de tags','N perguntas Feitas','N respostas Feitas','hora','Feriado/FimSem']
,
              'rating':var }
...
print(list)
pyplot.show()
arquivo = open('C:\\Users\\joaor\\Desktop\\tx.txt', 'w+')
for x in list:
