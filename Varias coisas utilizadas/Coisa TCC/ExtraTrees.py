...
perg2 = ['Feriado/FimSem','TemCodigo','N Palavras corpo','N Palavras Titulo','N frases corpo','flesch','Media Caracteres Frase','Tamanho Codigo','Interogacao','Inicia com WH','Subjetividade','Polaridade','N de tags','N perguntas Feitas','N respostas Feitas','Rotulo']
...
with open('C:\\Users\\joaor\\Desktop\\TCC\\Arq complementar\\Feriado20%.txt', 'r') as f:
    line=f.readlines()
...
'''print('TESTE %s' % Counter(y_test))
rus = RandomUnderSampler(random_state=SEED)

X_tr,y_train = rus.fit_resample(X_tr, y_train)
print('TREINO %s' % Counter(y_train))
'''
